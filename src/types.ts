...
export interface DateEntry {
  ...
  totalGamesInProgress: number;
  games: Array<Game>;
  events: Array<any>; // You might want to define a more specific type for events if they are not always empty
}
...
export interface ScheduleAndResults {
  ...
  scheduleList: Array<GameNotification>;
}
